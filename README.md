...
To get TypeScript support for auto-imported components, [Vue Language Tools](https://github.com/vuejs/language-tools) (formerly Volar) has supported this usage already. If you are using Vue Language Tools, you can change the config as following to get the support.
